...
- リリースフローの「試験モード」：開発中プレースホルダーのまま（[05_リリース_ストア申請/初回トライアルリリース_タスクリスト.md](../05_リリース_ストア申請/初回トライアルリリース_タスクリスト.md)項目1「今回のトライアル向け最低ライン」で見送り済み）
...
- 出題テンポ調整・振り返り（復習）機能・書き取りのテキスト入力化・総画数問題：[初回トライアルリリース_タスクリスト.md](../05_リリース_ストア申請/初回トライアルリリース_タスクリスト.md)項目1-1〜1-4/1-5で既にリリース後アップデート送りと決定済み（本ドキュメントで重複決定はしない）
...
残るTODO（モチベーション機能の見せ方）は[../ToDo.md](../ToDo.md)に集約済み。
...
- [x] **（2026-09-14追加）02_デザインとのすり合わせ・対象範囲の洗い出し**：本ドキュメントを実装に合わせて更新し、トライアルで触る画面／後回しにする画面を明文化した（[05_リリース_ストア申請/初回トライアルリリース_タスクリスト.md](../05_リリース_ストア申請/初回トライアルリリース_タスクリスト.md)項目2の残り2件に対応）
